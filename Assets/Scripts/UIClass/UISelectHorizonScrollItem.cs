...
namespace UIClass
{
    ...
    {
        [Tooltip("图片")][SerializeField] private Image image;
        [Tooltip("名称文字")][SerializeField] private TextMeshProUGUI nameText;
        [Tooltip("画布组")][SerializeField] private CanvasGroup canvasGroup;
        [Tooltip("选项索引")] public int itemIndex;
        [Tooltip("信息索引")] public int infoIndex;
        [Tooltip("描述文本")] public string description;
